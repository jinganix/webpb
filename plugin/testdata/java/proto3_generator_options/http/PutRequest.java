...
public class PutRequest implements WebpbMessage {

  public static final String WEBPB_METHOD = "PUT";
  ...
  public PutRequest(Integer id, String body) {
    this.id = id;
    this.body = body;
  }
  ...
  public PutRequest setId(Integer id) {
    this.id = id;
    return this;
  }
