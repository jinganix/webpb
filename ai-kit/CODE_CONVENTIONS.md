...
> Read this document before editing Java production code under `**/src/main/**`.  
...
After editing Java production code, verify build from repository root. Prefer auto-format first:
