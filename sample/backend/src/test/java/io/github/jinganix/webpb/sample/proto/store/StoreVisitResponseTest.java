...
@DisplayName("StoreVisitResponse")
class StoreVisitResponseTest {

  @Test
  @DisplayName("should return greeting and null store when store is unset")
  void shouldReturnGreetingAndNullStoreWhenStoreIsUnset() {
    // Given
    ...
    assertThat(response.getGreeting()).isEqualTo("hello");
  }
}
