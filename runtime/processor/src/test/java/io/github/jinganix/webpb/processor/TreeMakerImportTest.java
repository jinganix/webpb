...
class TreeMakerImportTest {
  ...
  @Test
  @DisplayName("should construct when import method is found")
  void shouldConstructWhenImportMethodIsFound() {
    // When / Then
    assertThatCode(TreeMakerImport::new).doesNotThrowAnyException();
  }

  @Test
  @DisplayName("should invoke import when called with tree maker")
  void shouldInvokeImportWhenCalledWithTreeMaker() {
    // Given
  ...
  @Test
  @DisplayName("should throw when import method invocation fails")
  void shouldThrowWhenImportMethodInvocationFails() throws Exception {
    // Given
    TreeMakerImport treeMakerImport = new TreeMakerImport();
