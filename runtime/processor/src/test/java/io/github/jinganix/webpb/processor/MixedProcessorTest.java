...
@DisplayName("MixedProcessor")
class MixedProcessorTest {

  @Test
  @DisplayName("should compile successfully when both processors run on sample1")
  void shouldCompileSuccessfullyWhenBothProcessorsRunOnSample1() {
    // When
